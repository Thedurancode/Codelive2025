...
export default function EditorHeader(props: PropsType) {
  ...
  const handleExport = async () => {
    try {
      ...
      toast.success('Code Export Completed!');
      setIsExporting(false);
    } catch (error) {
      console.error('Export failed:', error);
      toast.error('Failed to this code. Please try again.');
    }
  };
          ...
          <div className="flex items-center gap-2">
              ...
              <>
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>🛑 Stop This Server</TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </>
            ) : null}
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>⬇ Download This Code</TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
        </nav>
    ...
    >
      <DialogContent hideClose>
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">Rename this Project</DialogDescription>
          <div className="pt-2">
